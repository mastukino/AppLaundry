...
<body class="theme-red">
	...
	<section>
		...
		<aside id="leftsidebar" class="sidebar">
			...
			<div class="legal">
				<div class="copyright">
					&copy; Mei 2021 <a href="javascript:void(0);">KINO - Tukino Design</a>.
					<br>
					<center>
						<p>Repost by <a href="http://tukino.ktkbm-batam.com/" title="StokCoding.com" target="_blank">tukino.ktkbm-batam.com/</a></p>
					</center>
				</div>
			</div>
			<!-- #Footer -->
